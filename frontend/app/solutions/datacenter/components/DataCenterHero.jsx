...
export default function DataCenterHero() {
  ...
  return (
    <section 
      ref={heroRef}
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-zinc-900"
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        <div className={`transform transition-all duration-1000 ease-out ${
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto leading-relaxed">
            Build, manage, and optimize world-class data centers with cutting-edge infrastructure, 
            security, and performance solutions designed for the digital age.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button className="group relative px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-600 text-white font-semibold rounded-full text-lg shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1">
          ...
          {/* Data Center Capabilities Preview */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
            {[
              { icon: '🏗️', label: 'Infrastructure Design', color: 'from-blue-400 to-blue-600' },
              { icon: '🔒', label: 'Security & Compliance', color: 'from-cyan-400 to-cyan-600' },
              { icon: '⚡', label: 'Power & Cooling', color: 'from-indigo-400 to-indigo-600' },
              { icon: '🌐', label: 'Network Solutions', color: 'from-slate-400 to-slate-600' }
