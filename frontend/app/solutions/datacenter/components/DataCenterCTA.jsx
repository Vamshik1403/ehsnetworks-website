    ...
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-slate-900 via-gray-900 to-zinc-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`transform transition-all duration-1000 ease-out ${
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Transform your IT infrastructure with world-class data center solutions. 
              From design to deployment, we'll help you build a foundation for digital 
            ...
            <div className="space-y-4 mb-8">
              {[
                "🏗️ Custom-designed infrastructure for your needs",
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-white font-semibold">datacenter@enpl.com</div>
                </div>
              </div>
          ...
          <div className={`transform transition-all duration-1000 ease-out delay-300 ${
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">
                Get Your Free Data Center Consultation
              </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your data center project or requirements..."
                    required
                  ></textarea>
                </div>
        ...
        <div className={`mt-20 grid md:grid-cols-4 gap-8 text-center transform transition-all duration-1000 ease-out delay-500 ${
          ...
          {[
            { number: "100+", label: "Data Centers Built", icon: "🏗️" },
