      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        <div className={`transform transition-all duration-1000 ease-out ${
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto leading-relaxed">
            Transform your business with cutting-edge AI technologies. From machine learning to 
            natural language processing, we deliver intelligent solutions that drive innovation 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
            {[
              { icon: '🤖', label: 'Machine Learning', color: 'from-blue-400 to-blue-600' },
              { icon: '🧠', label: 'Deep Learning', color: 'from-purple-400 to-purple-600' },
              { icon: '💬', label: 'NLP', color: 'from-indigo-400 to-indigo-600' },
              { icon: '👁️', label: 'Computer Vision', color: 'from-cyan-400 to-cyan-600' }
