    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          {/* Right Side - Network Infrastructure Illustration */}
          <motion.div
            style={{ y, opacity }}
          ...
          >
            <div className="relative w-full max-w-lg h-96">
              ...
              >
                {/* Server Rack */}
                <div className="absolute top-8 left-16 w-20 h-32 bg-gray-700 rounded-lg border-2 border-gray-500">
                  <div className="grid grid-cols-2 gap-1 p-2">
                    <div className="w-6 h-4 bg-green-500 rounded border border-green-400"></div>
                    <div className="w-6 h-4 bg-green-500 rounded border border-green-400"></div>
                    <div className="w-6 h-4 bg-blue-500 rounded border border-blue-400"></div>
                    <div className="w-6 h-4 bg-blue-500 rounded border border-blue-400"></div>
                    <div className="w-6 h-4 bg-purple-500 rounded border border-purple-400"></div>
                    <div className="w-6 h-4 bg-purple-500 rounded border border-purple-400"></div>
                  </div>
                </div>

                {/* People and Equipment */}
                <div className="absolute top-16 right-8 w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center">
                  <span className="text-xs font-bold text-gray-600">👤</span>
                </div>

                <div className="absolute top-24 right-20 w-10 h-10 bg-gray-400 rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-white">💻</span>
                </div>

                <div className="absolute top-32 left-8 w-8 h-8 bg-orange-400 rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-white">⚙️</span>
                </div>

                <div className="absolute top-40 right-12 w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-white">🔑</span>
                </div>

                <div className="absolute top-48 left-24 w-8 h-8 bg-red-500 rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-white">🔒</span>
                </div>

                {/* Large Monitor */}
                <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 w-32 h-20 bg-gray-800 rounded-lg border-2 border-gray-600">
