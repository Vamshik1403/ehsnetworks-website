...
export default function RemoteManagedServicesOverview() {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-blue-600 mb-6">
            ENPL Remote Managed Services
          </h2>
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Remote managed services (RMS) is a type of IT support that provides organizations with 24/7 access to technical experts who can remotely monitor and manage their IT systems. RMS can help organizations to improve their IT performance, reduce their IT costs, and comply with industry regulations.
          </p>
        </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-white text-center md:text-left">
              ...
              <p className="text-blue-100">Contact us today to discuss your remote managed services needs</p>
            </div>
