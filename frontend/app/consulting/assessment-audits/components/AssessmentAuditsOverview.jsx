...
import { CheckCircle, TrendingUp, Shield, Users, Database, Server } from 'lucide-react';

export default function AssessmentAuditsOverview() {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true });

  const assessmentTypes = [
    {
      title: "Capacity & Availability Assessment",
      description: "We provide optimized forecast and capacity planning capability, across multi-vendor environments, which result in optimized investments without compromising availability and performance.",
      icon: TrendingUp,
      delay: 0.1
    },
    {
      title: "Security Assessment",
      description: "Comprehensive security evaluation to identify vulnerabilities, assess risks, and implement robust security measures to protect your infrastructure and data.",
      icon: Shield,
      delay: 0.2
    },
    {
      title: "Network Assessment",
      description: "Detailed analysis of your network infrastructure, performance metrics, and optimization opportunities to ensure seamless connectivity and data flow.",
      icon: Server,
      delay: 0.3
    },
    {
      title: "Infrastructure Assessment",
      description: "Complete evaluation of your IT infrastructure including servers, storage, and middleware to identify optimization opportunities and modernization paths.",
      icon: Database,
      delay: 0.4
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Comprehensive assessment and audit services to optimize your IT infrastructure, enhance security, and drive business performance.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Left Side - Assessment Types */}
          <motion.div
              ...
              {assessmentTypes.map((type, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                      {React.createElement(type.icon, { size: 24, className: "text-white" })}
                    </div>
                    <div>
          ...
          >
            <div className="relative w-full h-96 bg-gradient-to-br from-gray-800 to-blue-900 rounded-3xl overflow-hidden shadow-2xl">
              ...
              >
                ...
                {/* Tablet */}
                <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-20 h-16 bg-white rounded-lg border-2 border-gray-300">
              ...
              <motion.div
                ...
                className="absolute top-16 left-24 w-8 h-8 bg-orange-400 rounded-lg opacity-80 flex items-center justify-center"
              >
              ...
              <motion.div
                ...
                className="absolute top-24 right-24 w-8 h-8 bg-blue-400 rounded-lg opacity-80 flex items-center justify-center"
              >
