...
export default function AssessmentAuditsCTA() {
  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-br from-blue-50 via-gray-50 to-indigo-50 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Don't wait for issues to arise. Our comprehensive assessment services will identify opportunities for improvement and optimization before they become problems.
          </p>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Ready to start your assessment journey? Contact us today!
              </p>
            </motion.div>
          ...
          >
            ...
            <form className="space-y-6">
              ...
              >
                <button
                  type="submit"
                  className="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
                  Request Assessment
                </button>
              </motion.div>
