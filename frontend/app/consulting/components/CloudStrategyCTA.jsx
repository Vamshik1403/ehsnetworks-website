...
export default function CloudStrategyCTA() {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-blue-600 mb-6">
            Your Cloud Compass Awaits:
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Don't embark on your cloud migration blindly. With ENPL Office Automation's Cloud Assessment as your guide, 
            you'll have the knowledge, insights, and roadmap to confidently navigate your journey to the cloud.
          </p>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Ready to start your cloud strategy journey? Contact us today!
              </p>
            </motion.div>
            ...
            <form className="space-y-6">
              ...
              >
                ...
                <textarea
                  ...
                  placeholder="Tell us about your cloud strategy needs..."
                />
              </motion.div>
